		...
		<div id="wrapper">
			<div id="container3" style="width:auto;height:400px;"></div>
		</div>
		...
		<script type="text/javascript">
			...
			document.observe('dom:loaded', function(){
				...
				/*** Draw the graph ***/
			    f = Flotr.draw($('container3'),[  
						{data:d0, label:'lambda: 1  y k:[0...20]', yaxis:1,  lines: {show: true}, points: {show: false}},
						{data:d1, label:'lambda: 4  y k:[0...20]', yaxis:1,  lines: {show: true}, points: {show: false}},
						{data:d2, label:'lambda: 10 y k:[0...20]', yaxis:1,  lines: {show: true}, points: {show: false}}
					],{
						xaxis:{
							noTicks: 20,
