	...
	<div class="site-wrapper">
			<div class="site-wrapper-inner">
				...
				<div class="col-lg-12 col-sm-12 col-xs-12">
					...
					<h4>Luis Pérez</h4><p>para la materia Fundamentos de Optimización Computacional</p>
				<p class="lead">  
				...
				<!--<div class="col-lg-4 col-sm-4 col-xs-12">
					...
					<div class="mastfoot">
						<div class="inner">
							<p>Fundamentos de Optimización Computacional<br>Agosto ~ Paro ~ Noviembre de 2015.</p>
						</div>
					</div>
				</div>
			</div>
